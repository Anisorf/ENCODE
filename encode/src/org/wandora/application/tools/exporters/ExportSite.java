...
public class ExportSite extends AbstractExportTool implements WandoraTool, ActionListener {
    ...
    private void collectParams(HashMap localParams, Topic currentTopic, TopicMap topicMap, Locale loc) {
        ...
        try { localParams.put("collectionmaker", new org.wandora.piccolo.utils.InstanceMaker("java.util.HashSet")); } catch (Exception e) {}
        try { localParams.put("listmaker", new org.wandora.piccolo.utils.InstanceMaker("java.util.ArrayList")); } catch (Exception e) {}
        try { localParams.put("mapmaker", new org.wandora.piccolo.utils.InstanceMaker("java.util.HashMap")); } catch (Exception e) {}
        try { localParams.put("stackmaker", new org.wandora.piccolo.utils.InstanceMaker("java.util.Stack")); } catch (Exception e) {}
        localParams.put("urlencoder", org.wandora.piccolo.utils.URLEncoder.class);
        localParams.put("javascriptencoder", org.wandora.piccolo.utils.JavaScriptEncoder.class);
        localParams.put("tmbox", new org.wandora.topicmap.TMBox());
        localParams.put("textbox", new org.wandora.piccolo.utils.TextBox());
