...
public class UClassifierDialog extends javax.swing.JDialog {
    ...
    public UClassifierDialog(Wandora admin, boolean modal) {
        super(admin, modal);
        this.wandora = admin;
        initComponents();
        //initialize(null);
    ...
    public void initialize(WandoraTool parentTool, String[] cs) {
        initialize(parentTool);
        for(int i=0; i<cs.length; i=i+2) {
            classifierComboBox.addItem(new UClassifierOption(cs[i], cs[i+1]));
        }
        classifierComboBox.setEditable(false);
    }
    ...
    public String getClassifier() {
        UClassifierOption co = (UClassifierOption) classifierComboBox.getSelectedItem();
        if(co != null) {
            return co.getName();
        }
        return null;
    ...
    private void initComponents() {
        ...
        forgetApiKeyButton.setMargin(new java.awt.Insets(2, 4, 2, 4));
        ...
        urlLabel.setText("<html>Select URL resources you want to classify. Write URL addresses below or get subjects of context topics.</html>");
        ...
        crawlerComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "exactly given urls", "given urls and directly linked documents", "given urls and crawled documents in url domain", "given urls and all crawled documents" }));
        ...
        fileLabel.setText("<html>Select files you want to classify. Write, browse or get subject locator files. Text field accepts also dropped files.</html>");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        ...
        rawLabel.setText("<html>Paste or write text content you want to classify. Field accepts text drops also.</html>");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        ...
        classifierPanel.setLayout(new java.awt.GridBagLayout());

        classifierLabel.setText("Select uClassifier");
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 4);
        classifierPanel.add(thresholdLabel, gridBagConstraints);
        ...
        extractButton.setText("Classify");
...
private void forgetApiKeyButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_forgetApiKeyButtonMouseReleased
    if(parentTool != null && parentTool instanceof AbstractUClassifier) {
        ((AbstractUClassifier) parentTool).forgetAuthorization();
         WandoraOptionPane.showMessageDialog(this, "Wandora asks new api key next time you access the uClassify web service.", "uClassify Api Key Forgot");
    }
    ...
    private class UClassifierOption {
        
        private String name = null;
        private String owner = null;
        
        
        public UClassifierOption(String n, String o) {
            name = n;
            owner = o;
        }
