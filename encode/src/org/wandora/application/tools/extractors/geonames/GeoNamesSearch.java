...
public class GeoNamesSearch extends AbstractGeoNamesExtractor {
    ...
    public String getName() {
        return "GeoNames search extractor";
    }
    
    
    @Override
    public String getDescription(){
        return "Search geo locations from GeoNames web api and converts search results to a topic map.";
    }
    ...
    */
    ...
    public boolean _extractTopicsFrom(InputStream in, TopicMap topicMap) throws Exception {        
        ...
        GeoNamesSearchParser parserHandler = new GeoNamesSearchParser(topicMap,this,dataLang);
    ...
    private class GeoNamesSearchParser extends AbstractGeoNamesParser {

        
        public GeoNamesSearchParser(TopicMap tm, AbstractGeoNamesExtractor parent, String lang){
