...
/**
 * See http://ws.geonames.org/siblings?geonameId=3017382&style=full
 * 
 * @author akivela
 */
public class GeoNamesSiblings extends AbstractGeoNamesExtractor {
    ...
    public String getName() {
        return "GeoNames siblings extractor";
    }
    
    
    @Override
    public String getDescription(){
        return "Get siblings of given geo location and convert siblings to a topic map. ";
    }
    ...
    public boolean _extractTopicsFrom(InputStream in, TopicMap topicMap) throws Exception {        
        ...
        SiblingsParser parserHandler = new SiblingsParser(topicMap,this,dataLang);
        ...
        if(parserHandler.progress == 0) log("No siblings found!");
        else if(parserHandler.progress == 1) log("One sibling found!");
        else log("Total " + parserHandler.progress + " siblings found!");
    ...
    private static class SiblingsParser extends AbstractGeoNamesParser {
        
        
        public SiblingsParser(TopicMap tm, AbstractGeoNamesExtractor parent, String lang){
                ...
                try {
                    ...
                    try {
                        ...
                        if(isValid(requestGeoObject)) {
                            ...
                            if(theGeoObject.isRemoved()) theGeoObject=tm.getTopic(theGeoObjectSI);
                            makeSiblings(requestTopic, theGeoObject, tm);
                        }
                        if(isValid(data_lat) &&
                           isValid(data_lng)) {
