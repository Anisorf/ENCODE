...
public class GeoNamesWikipediaBBox extends AbstractGeoNamesExtractor {
    ...
    public String getName() {
        return "GeoNames wikipedia bounding box extractor";
    }
    
    
    @Override
    public String getDescription(){
        return "Get wikipedia geo locations in given bounding box from GeoNames web api and convert results to a topic map.";
    }
    ...
    */
    ...
    public boolean _extractTopicsFrom(InputStream in, TopicMap topicMap) throws Exception {        
        ...
        GeoNamesWikipediaBBoxParser parserHandler = new GeoNamesWikipediaBBoxParser(topicMap,this,dataLang);
    ...
    private class GeoNamesWikipediaBBoxParser extends AbstractGeoNamesWikipediaParser {

        
        public GeoNamesWikipediaBBoxParser(TopicMap tm, AbstractGeoNamesExtractor parent, String lang){
