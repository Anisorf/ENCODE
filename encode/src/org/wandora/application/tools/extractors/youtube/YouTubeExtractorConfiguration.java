/*
 * YouTubeExtractorConfiguration.java
 *
 * Created on 8. elokuuta 2008, 22:00
 */
...
public class YouTubeExtractorConfiguration extends javax.swing.JDialog {
    ...
    public YouTubeExtractorConfiguration(JFrame parent, Options options, YouTubeExtractor parentTool) {
        super(parent, true);
        this.parent = parent;
    ...
    private void initComponents() {
        ...
        clearAuthButton = new SimpleButton();
        footerPanel = new javax.swing.JPanel();
        fillerPanel = new javax.swing.JPanel();
        closeButton = new SimpleButton();

        setTitle("YouTube Extraction Configuration");
        getContentPane().setLayout(new java.awt.GridBagLayout());

        contentPanel.setLayout(new java.awt.GridBagLayout());

        clearAuthButton.setText("Forget YouTube Username and Password");
