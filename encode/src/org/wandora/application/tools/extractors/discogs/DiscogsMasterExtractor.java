...
public class DiscogsMasterExtractor extends AbstractDiscogsExtractor {
    ...
    public String getName() {
        return "Discogs API Master extractor";
    }
    @Override
    public String getDescription(){
        return "Extractor fetches master data from Discogs API.";
    }
    ...
    public void parseMaster(JSONObject json, TopicMap tm) throws TopicMapException {
        if(json.has("results")) {
            try {
                ...
                if (resultsArray.length() > 0) {
                    ...
                    log("Search returned " + count + " masters.");
                } else {
    ...
    public void parseResult(JSONObject result, TopicMap tm) throws JSONException, TopicMapException {
        ...
        if(result.has("uri") && result.has("id")) {
            ...
            itemTopic.addType(getMasterTypeTopic(tm));
