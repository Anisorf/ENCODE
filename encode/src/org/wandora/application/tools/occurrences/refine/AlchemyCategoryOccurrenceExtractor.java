...
public class AlchemyCategoryOccurrenceExtractor extends AbstractOccurrenceExtractor {
    ...
    public String getName() {
        return "Alchemy category occurrence extractor";
    }
    ...
    public boolean _extractTopicsFrom(String occurrenceData, Topic masterTopic, TopicMap topicMap, Wandora wandora) throws Exception {
        ...
        if(occurrenceData != null && occurrenceData.length() > 0) {
            ...
            if(apikey != null && apikey.length() > 0) {
                ...
                String alchemyURL = AlchemyCategoryExtractor.ALCHEMY_URL+"calls/text/TextGetCategory"; // ?apikey="+apikey+"&outputMode=xml&text="+URLEncoder.encode(content, "utf-8");
                ...
                AlchemyCategoryExtractor.AlchemyCategoryParser parserHandler = extractor.new AlchemyCategoryParser(masterTerm, content, topicMap, extractor);
