...
public class OccurrenceGoogleTranslate extends AbstractWandoraTool implements WandoraTool {
    ...
    public OccurrenceGoogleTranslate(Context preferredContext) {
    ...
    public String getName() {
        return "Translate occurrence with Google";
    }

    @Override
    public String getDescription() {
        return "Translates given occurrence texts using Google Translate.";
    }
            ...
            try {
                if(topics.hasNext()) {
                    ...
                    if(selectLanguages.wasAccepted()) {
                        ...
                        log("Translating occurrences with Google Translate.");
                        ...
                        sourceScope = tm.getTopic(XTMPSI.LANG_PREFIX+GoogleTranslateBox.getLanguageCodeFor(sourceLang));
                        if(sourceScope != null) {
                                        ...
                                        if(occurrence != null) {
                                            for(T2<Language,Topic> target : targetScopes) {
                                                ...
                                                if(overrideExisting || existingOccurrence == null) {
                                                    String translatedOccurrence = GoogleTranslateBox.translate(occurrence, sourceLang, targetLang, markTranslation);
