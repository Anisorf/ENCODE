...
public class SimbergOAIDCExporter extends AbstractExportTool implements WandoraTool {
    ...
    public void execute(Wandora admin, Context context) {
       ...
       String exportInfo = null;
        ...
        if(topicMapName != null) {
            exportInfo =  "Exporting topic map in layer '" + topicMapName + "' as FNG Simberg OAI Dublin Core";
        }
        else {
            exportInfo =  "Exporting topic map as FNG Simberg OAI Dublin Core";
        ...
        if(chooser.open(admin, "Export")==SimpleFileChooser.APPROVE_OPTION){
            ...
            try {
                ...
                data.exportOAIDC(zipStream, getCurrentLogger());
    ...
    public String getName() {
        return "Export FNG Simberg OAI Dublin Core dump";
    }
