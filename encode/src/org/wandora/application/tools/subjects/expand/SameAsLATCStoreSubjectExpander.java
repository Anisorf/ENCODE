...
public class SameAsLATCStoreSubjectExpander extends SameAsSubjectExpander {
    ...
    public String getName() {
        return "Expand subject with sameas.org's LATC store";
    }

    @Override
    public String getDescription() {
        return "Add topic subjects returned by the LATC store of sameas.org service.";
    }
    ...
    protected String getExpandingRequestBase() {
        return "http://sameas.org/store/latc/json";
    }
