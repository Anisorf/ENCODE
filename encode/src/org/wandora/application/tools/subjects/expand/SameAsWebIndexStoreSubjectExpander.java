...
public class SameAsWebIndexStoreSubjectExpander extends SameAsSubjectExpander {
    ...
    public String getName() {
        return "Expand subject with sameas.org's Web Index store";
    }

    @Override
    public String getDescription() {
        return "Add topic subjects returned by the Web Index store of sameas.org service.";
    }
    ...
    protected String getExpandingRequestBase() {
        return "http://sameas.org/store/webindex/json";
    }
}
