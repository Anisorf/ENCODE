...
public class SameAsMusicNetStoreSubjectExpander extends SameAsSubjectExpander {
    ...
    public String getName() {
        return "Expand subject with sameas.org's MusicNet store";
    }

    @Override
    public String getDescription() {
        return "Add topic subjects returned by the MusicNet store of sameas.org service.";
    }
    ...
    protected String getExpandingRequestBase() {
        return "http://sameas.org/store/musicnet/json";
    }
