...
public class SameAsKelleStoreSubjectExpander extends SameAsSubjectExpander {
    ...
    public String getName() {
        return "Expand subject with sameas.org's Kelle store";
    }

    @Override
    public String getDescription() {
        return "Add topic subjects returned by the Kelle store of sameas.org service.";
    }
    ...
    protected String getExpandingRequestBase() {
        return "http://sameas.org/store/kelle/json";
    }
