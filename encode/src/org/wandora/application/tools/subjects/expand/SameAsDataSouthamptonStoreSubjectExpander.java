...
public class SameAsDataSouthamptonStoreSubjectExpander extends SameAsSubjectExpander {
    ...
    public String getName() {
        return "Expand subject with sameas.org's Data Southampton store";
    }

    @Override
    public String getDescription() {
        return "Add topic subjects returned by the Data Southampton store of sameas.org service.";
    }
    ...
    protected String getExpandingRequestBase() {
        return "http://sameas.org/store/datasouthamptonacuk/json";
    }
