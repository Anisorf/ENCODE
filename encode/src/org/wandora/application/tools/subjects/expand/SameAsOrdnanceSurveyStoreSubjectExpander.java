...
public class SameAsOrdnanceSurveyStoreSubjectExpander extends SameAsSubjectExpander {
    ...
    public String getName() {
        return "Expand subject with sameas.org's Ordnance Survey store";
    }

    @Override
    public String getDescription() {
        return "Add topic subjects returned by the Ordnance Survey store of sameas.org service.";
    }
    ...
    protected String getExpandingRequestBase() {
        return "http://sameas.org/store/ordnancesurvey/json";
    }
