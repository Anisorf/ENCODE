...
public class SameAsFreebaseStoreSubjectExpander extends SameAsSubjectExpander {
    ...
    public String getName() {
        return "Expand subject with sameas.org's Freebase store";
    }

    @Override
    public String getDescription() {
        return "Add topic subjects returned by the Freebase store of sameas.org service.";
    }
    ...
    protected String getExpandingRequestBase() {
        return "http://sameas.org/store/freebase/json";
    }
}
