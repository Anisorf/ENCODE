...
public class SameAsBritishLibraryStoreSubjectExpander extends SameAsSubjectExpander {
    ...
    public String getName() {
        return "Expand subject with sameas.org's British Library store";
    }

    @Override
    public String getDescription() {
        return "Add topic subjects returned by the British Library store of sameas.org service.";
    }
    ...
    protected String getExpandingRequestBase() {
        return "http://sameas.org/store/britishlibrary/json";
    }
