...
public class SameAsEmailStoreSubjectExpander extends SameAsSubjectExpander {
    ...
    public String getName() {
        return "Expand subject with sameas.org's Email store";
    }

    @Override
    public String getDescription() {
        return "Add topic subjects returned by the Email store of sameas.org service.";
    }
    ...
    protected String getExpandingRequestBase() {
        return "http://sameas.org/store/email/json";
    }
