...
public class SameAsVIAFStoreSubjectExpander extends SameAsSubjectExpander {
    ...
    public String getName() {
        return "Expand subject with sameas.org's VIAF store";
    }

    @Override
    public String getDescription() {
        return "Add topic subjects returned by the VIAF (Virtual International Authority File) store of sameas.org service.";
    }
    ...
    protected String getExpandingRequestBase() {
        return "http://sameas.org/store/viaf/json";
    }
}
