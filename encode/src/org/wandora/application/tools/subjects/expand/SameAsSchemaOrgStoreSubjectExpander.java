...
public class SameAsSchemaOrgStoreSubjectExpander extends SameAsSubjectExpander {
    ...
    public String getName() {
        return "Expand subject with sameas.org's schema.org store";
    }

    @Override
    public String getDescription() {
        return "Add topic subjects returned by the schema.org store of sameas.org service.";
    }
    ...
    protected String getExpandingRequestBase() {
        return "http://sameas.org/store/schema_org/json";
    }
