...
public class XTMWebApp extends AbstractTopicWebApp {
    ...
    public boolean handleAction(HttpServletRequest req, HttpServletResponse resp, ModulesServlet.HttpMethod method, String action, User user) throws ServletException, IOException, ActionException {
        try {
            ...
            if(topic != null) {
                ...
                TopicMap outTm = new TopicMapImpl();
                outTm.copyTopicIn(topic, deepCopy);
                outTm.copyTopicAssociationsIn(topic);
                outTm.exportXTM20(out, outTm);
