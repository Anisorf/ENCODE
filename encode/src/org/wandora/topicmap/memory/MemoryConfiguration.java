...
public class MemoryConfiguration extends TopicMapConfigurationPanel {
    ...
    private void initComponents() {
        ...
        emptyRadioButton = new SimpleRadioButton();
        loadMiniSchemaRadioButton = new SimpleRadioButton();
        loadXTMPanel = new javax.swing.JPanel();
        loadRadioButton = new SimpleRadioButton();
        sourceTextField = new SimpleField();
        ...
        sourceTextField.setPreferredSize(new java.awt.Dimension(6, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        browseButton.setMargin(new java.awt.Insets(1, 6, 1, 6));
        browseButton.setMinimumSize(new java.awt.Dimension(69, 20));
        browseButton.setPreferredSize(new java.awt.Dimension(69, 21));
