 ...
 * 
 *
 * SelectGoogleTranslationLanguagesPanel.java
 *
 ...
 * @author akivela
 */
public class SelectGoogleTranslationLanguagesPanel extends javax.swing.JPanel {
    ...
    /** Creates new form SelectGoogleTranslationLanguagesPanel */
    public SelectGoogleTranslationLanguagesPanel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        infoLabel.setText("<html>Select source and target langugages. Checking Show all languages views all languages available in Google Translate API. Checking Mark translated text adds translation a static suffix helping to recognize and verify translations.</html>");
